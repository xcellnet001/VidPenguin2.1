  ...
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .whenAuthenticated('/account', {
	    ...
	    .whenAuthenticated('/drip', {
        templateUrl: 'views/drip.html',
        controller: 'DripCtrl'
      })
      .whenAuthenticated('/feeds', {
        templateUrl: 'views/feeds.html',
        controller: 'FeedsCtrl'
      })
      .whenAuthenticated('/ping', {
      ...
      .whenAuthenticated('/help', {
        templateUrl: 'views/help.html',
        controller: 'HelpCtrl'
      })
      .whenAuthenticated('/api', {
        templateUrl: 'views/api.html',
        controller: 'ApiCtrl'
      })
      .whenAuthenticated('/links', {
        templateUrl: 'views/links.html',
        controller: 'LinksCtrl'
      })
      .whenAuthenticated('/boost', {
        templateUrl: 'views/boost.html',
        controller: 'BoostCtrl'
      })
      .whenAuthenticated('/integrations', {
        templateUrl: 'views/integrations.html',
        controller: 'IntegrationsCtrl'
      })
      .whenAuthenticated('/base', {
        templateUrl: 'views/base.html',
        controller: 'BaseCtrl'
      })
      .whenAuthenticated('/url_var', {
        templateUrl: 'views/url_var.html',
        controller: 'UrlVarCtrl'
      })
      .whenAuthenticated('/links', {
        templateUrl: 'views/links.html',
        controller: 'LinksCtrl'
      })
      .whenAuthenticated('/feed/:feedID', {
        templateUrl: 'views/feed.html',
        controller: 'FeedCtrl'
      })
      .when('/channelMaster', {
        templateUrl: 'views/channelmaster.html',
        controller: 'ChannelmasterCtrl'
      })
